...
const Icon = (props) => {
    return <>
        <div {...props} className="border hover:content-['Google'] hover:bg-[#1877f2] w-12 h-12 fill-[#1877f2] hover:fill-white border-blue-200 rounded-full flex items-center justify-center shadow-xl hover:shadow-blue-500/50 cursor-pointer">
